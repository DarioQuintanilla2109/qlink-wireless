        ...
        <div className='f4'>
          ...
          <ul className='list1'>
            ...
            <li>
              ...
              phone which I love and I have never had a problem. I use my phone
              to make appointmnents and stay connected with my work, friends and
              family."
            </li>
          </ul>
        </div>
